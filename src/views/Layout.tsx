...
// All CSS lives in this string constant. We inject it via
// dangerouslySetInnerHTML to avoid JSX escaping quotes and
// ampersands in CSS (e.g. "SF Pro" → &quot;SF Pro&quot;).
const css = `
  /* === Reset & Base === */
  *, *::before, *::after {
  ...
  html {
    /* SF Pro is Apple's system font. system-ui falls back on other OSes */
  ...
  /* Each full-width section of the homepage */
  .section {
    padding: 80px 69px;
  }
  ...
  /* Tag badge — bordered pill with coloured text */
  .badge {
    display: inline-flex;
    align-items: center;
...
// CSS is inlined in a <style> tag — no build step needed, no external files.
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/*
          dangerouslySetInnerHTML bypasses JSX's HTML escaping.
          Without it, CSS quotes and ampersands get escaped
          (e.g. "SF Pro" → &quot;SF Pro&quot;) which breaks styles.
          This is the standard JSX pattern for injecting raw HTML.
        */}
